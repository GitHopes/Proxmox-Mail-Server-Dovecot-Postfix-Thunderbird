...
Esto nos permite comunicarnos con nosotros mismos en el servidor para el dominio mail.server, util para realizar pruebas de funcionamiento desde nuestro propio servidor.
